...
module.exports = {
	ajax: {
		get: function get(url, data, success, err) {
		...
		post: function post(url, data, success, err) {
			var sendData;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('span', [_vm._v(_vm._s(_vm.title))]), _vm._v(" "), _c('a', [_vm._v("×")])]), _vm._v(" "), _vm._t("modal-body", [_c('div', {
...
new _vue2.default({
	...
	methods: {
		toNewArticle: function toNewArticle() {
		...
		saveInfo: function saveInfo() {
			...
			_common2.default.ajax.post('/admin/user/info/update', sendInfo, s, s);
		},
		sendData: function sendData() {
			...
			if (me.isReco) {
				...
				_common2.default.ajax.post('/admin/category/new', { name: me.addCateName }, function (str) {
					console.log(str);
				}, function (str) {
					console.log(str);
				});
		...
		initReco: function initReco() {
			this.config.title = '添加推荐';
			this.showModal = true;
			this.isReco = true;
		},
		initCate: function initCate() {
		...
		deleteArticle: function deleteArticle(id) {
			_common2.default.ajax.del('/admin/article/' + id, function (str) {
				console.log(str);
			}, function (str) {
				console.log(str);
			});
		...
		deleteCategory: function deleteCategory(id) {
			_common2.default.ajax.del('/admin/category/' + id, function (str) {
				console.log(str);
			}, function (str) {
				console.log(str);
			});
