...
new _vue2.default({
	el: '#container',
	data: {
		topNav: [{ name: '首页管理', urls: '/admin/index' }, { name: '文章管理', urls: '/admin/index' }, { name: '杂记管理', urls: '/admin/index' }],
		article: {
			title: '',
			description: '',
			category: [],
	...
	methods: {
		sumbit: function sumbit() {
			...
			if (me.article.newCate !== '') me.article.category.push(me.article.newCate);
			console.log(me.article);
			_common2.default.ajax.post('/admin/article/new', me.article, s, s);
		}
	}
});
